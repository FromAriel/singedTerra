...
const BUILT_INS: Readonly<Record<string, ComposableContentProfile>> = Object.freeze({
  ...
  'profile.d': { style: 'pulse', copies: 3, pace: 21, arcWidth: 0, spacingTicks: 3, impactScore: 5, terrainPixels: 1, color: '#ffd97d' },
  'profile.e': { style: 'pulse', copies: 4, pace: 23, arcWidth: 0, spacingTicks: 2, impactScore: 5, terrainPixels: 1, color: '#ffd166' },
  'profile.f': { style: 'pulse', copies: 3, pace: 25, arcWidth: 0, spacingTicks: 3, impactScore: 8, terrainPixels: 2, color: '#ffc857' },
  'profile.g': { style: 'fan', copies: 9, pace: 17, arcWidth: 18, spacingTicks: 1, impactScore: 3.5, terrainPixels: 1, color: '#ffcf70' },
  'profile.h': { style: 'fan', copies: 12, pace: 18, arcWidth: 22, spacingTicks: 1, impactScore: 3, terrainPixels: 1, color: '#ffbf69' },
  'profile.i': { style: 'pulse', copies: 16, pace: 24, arcWidth: 0, spacingTicks: 1, impactScore: 2.4, terrainPixels: 1, color: '#ffe07a' },
  'profile.j': { style: 'wall', copies: 12, pace: 21, arcWidth: 12, spacingTicks: 1, impactScore: 4, terrainPixels: 1, color: '#ffad5a' },
});
